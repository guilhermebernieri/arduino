...
void loop(){
  ...
  // Os valores do acelerômetro vão aproximadamente de -16000 até 16000, (32000 valores).
  angulo = 180.0 * acel_y / 32000.0; // converte os valores de aceleração em ângulo

  // Limita o angulo ao intervalo de -90 a 90
